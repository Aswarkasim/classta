      ...
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <?php if ($this->session->userdata('id_kelas')) { ?>
          <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-left mb-md-0">
            <li><a href="<?= base_url('siswa/dashboard'); ?>" class="nav-link px-2 link-dark">Dashboard</a></li>
            <li><a href="<?= base_url('siswa/modul'); ?>" class="nav-link px-2 link-dark">Belajar</a></li>
            <li><a href="<?= base_url('siswa/ujian'); ?>" class="nav-link px-2 link-dark">Ujian</a></li>
          </ul>
        <?php } ?>
        ...
        <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
          <div class="dropdown text-end">
            ...
            <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1" data-popper-placement="top-start" style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate(0px, -34px);">
              <li><a class="dropdown-item" href="<?= base_url('user/kelas'); ?>">Profil</a></li>
              <li><a class="dropdown-item" href="<?= base_url('siswa/kelas'); ?>">Ubah Kelas</a></li>
              <li>
